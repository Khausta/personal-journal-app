...
import styles from './JournalItemAddButton.module.css';

function JournalItemAddButton({ clearForm }) {

	return (
		<CardButton className={styles["journal-item-add"]} onClick={clearForm}>
